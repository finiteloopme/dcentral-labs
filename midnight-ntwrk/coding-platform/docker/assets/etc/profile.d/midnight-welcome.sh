...
# This file is sourced by all login shells via /etc/profile.d
#

# Only run in interactive shells to avoid breaking non-interactive commands
case $- in
    *i*) ;;
    *) return;;
esac
...
# Ensure OpenCode directories exist (quietly)
