...
func ParseFlags() (*Config, error) {
	...
	flag.StringVar(&cfg.RPCEndpoint, "rpc-endpoint", "https://governors.testnet.redbelly.network", "The RPC endpoint of the EVM chain")
	flag.StringVar(&cfg.WebsocketEndpoint, "ws-endpoint", "wss://governors.testnet.redbelly.network/ws", "The Websocket endpoint of the EVM chain")
