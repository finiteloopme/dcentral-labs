...
func (_StockAsset *StockAssetCaller) GetUserAssetIds(opts *bind.CallOpts, user common.Address) ([]*big.Int, error) {
	var out []interface{}
	err := _StockAsset.contract.Call(opts, &out, "getUserAssetIds", user)
...
//
// Solidity: function getUserAssetIds(address user) view returns(uint256[])
func (_StockAsset *StockAssetSession) GetUserAssetIds(user common.Address) ([]*big.Int, error) {
	return _StockAsset.Contract.GetUserAssetIds(&_StockAsset.CallOpts, user)
}

// GetUserAssetIds is a free data retrieval call binding the contract method 0x4e883ac7.
//
// Solidity: function getUserAssetIds(address user) view returns(uint256[])
func (_StockAsset *StockAssetCallerSession) GetUserAssetIds(user common.Address) ([]*big.Int, error) {
	return _StockAsset.Contract.GetUserAssetIds(&_StockAsset.CallOpts, user)
}
...
// BuyAsset is a paid mutator transaction binding the contract method 0x09b69e8d.
//
// Solidity: function buyAsset(uint256 id, uint256 tokenCount) payable returns()
func (_StockAsset *StockAssetTransactor) BuyAsset(opts *bind.TransactOpts, id *big.Int, tokenCount *big.Int) (*types.Transaction, error) {
	return _StockAsset.contract.Transact(opts, "buyAsset", id, tokenCount)
}

// BuyAsset is a paid mutator transaction binding the contract method 0x09b69e8d.
//
// Solidity: function buyAsset(uint256 id, uint256 tokenCount) payable returns()
func (_StockAsset *StockAssetSession) BuyAsset(id *big.Int, tokenCount *big.Int) (*types.Transaction, error) {
	return _StockAsset.Contract.BuyAsset(&_StockAsset.TransactOpts, id, tokenCount)
}

// BuyAsset is a paid mutator transaction binding the contract method 0x09b69e8d.
//
// Solidity: function buyAsset(uint256 id, uint256 tokenCount) payable returns()
func (_StockAsset *StockAssetTransactorSession) BuyAsset(id *big.Int, tokenCount *big.Int) (*types.Transaction, error) {
	return _StockAsset.Contract.BuyAsset(&_StockAsset.TransactOpts, id, tokenCount)
}
...
// SellAsset is a paid mutator transaction binding the contract method 0xbbc263fa.
//
// Solidity: function sellAsset(uint256 id, uint256 tokenCount) returns()
func (_StockAsset *StockAssetTransactor) SellAsset(opts *bind.TransactOpts, id *big.Int, tokenCount *big.Int) (*types.Transaction, error) {
	return _StockAsset.contract.Transact(opts, "sellAsset", id, tokenCount)
}

// SellAsset is a paid mutator transaction binding the contract method 0xbbc263fa.
//
// Solidity: function sellAsset(uint256 id, uint256 tokenCount) returns()
func (_StockAsset *StockAssetSession) SellAsset(id *big.Int, tokenCount *big.Int) (*types.Transaction, error) {
	return _StockAsset.Contract.SellAsset(&_StockAsset.TransactOpts, id, tokenCount)
}

// SellAsset is a paid mutator transaction binding the contract method 0xbbc263fa.
//
// Solidity: function sellAsset(uint256 id, uint256 tokenCount) returns()
func (_StockAsset *StockAssetTransactorSession) SellAsset(id *big.Int, tokenCount *big.Int) (*types.Transaction, error) {
	return _StockAsset.Contract.SellAsset(&_StockAsset.TransactOpts, id, tokenCount)
}
