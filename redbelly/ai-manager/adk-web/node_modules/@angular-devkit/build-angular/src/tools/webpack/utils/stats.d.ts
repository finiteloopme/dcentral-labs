...
import { Schema as BrowserBuilderOptions } from '@angular-devkit/build-angular/src/builders/browser/schema';
import { WebpackStatsOptions } from '@angular-devkit/build-angular/src/tools/webpack/utils/helpers';
